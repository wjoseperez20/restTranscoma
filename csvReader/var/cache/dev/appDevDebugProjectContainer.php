...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.listener.command_exception' => 'getApp_Listener_CommandExceptionService',
            ...
            'console_command.csv_import' => 'getConsoleCommand_CsvImportService',
            ...
            'monolog.handler.my_channel' => 'getMonolog_Handler_MyChannelService',
            'monolog.handler.null_internal' => 'getMonolog_Handler_NullInternalService',
            'monolog.logger.cache' => 'getMonolog_Logger_CacheService',
            'monolog.logger.doctrine' => 'getMonolog_Logger_DoctrineService',
            'monolog.logger.event' => 'getMonolog_Logger_EventService',
            'monolog.logger.my_channel' => 'getMonolog_Logger_MyChannelService',
        ...
        $this->aliases = array(
            ...
            'console.command.appbundle_command_csvimportcommand' => 'console_command.csv_import',
    ...
    /**
     * Gets the public 'app.listener.command_exception' shared service.
     *
     * @return \AppBundle\EventListener\ConsoleExceptionListener
     */
    protected function getApp_Listener_CommandExceptionService()
    {
        return $this->services['app.listener.command_exception'] = new \AppBundle\EventListener\ConsoleExceptionListener($this->get('monolog.logger.my_channel'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('H4TzStUob-', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GzHLh6b7KM', 0, 'uR8JXtdcdG+hprmGeUozXH', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the public 'console_command.csv_import' shared service.
     *
     * @return \AppBundle\Command\CsvImportCommand
     */
    protected function getConsoleCommand_CsvImportService()
    {
        return $this->services['console_command.csv_import'] = new \AppBundle\Command\CsvImportCommand($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'csvReaderDua', 'user' => 'wjoseperez', 'password' => '3squ3l3t0', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_18a893375a109341c80b7986b99b6ea9c2019e21cd7f002078bc8063c7b0be5a');
    ...
    /**
     * Gets the public 'monolog.handler.my_channel' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected function getMonolog_Handler_MyChannelService()
    {
        $this->services['monolog.handler.my_channel'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/dev-my_channel.log'), 100, true, NULL);
    ...
    /**
     * Gets the public 'monolog.logger.my_channel' shared service.
     *
     * @return \Symfony\Bridge\Monolog\Logger
     */
    protected function getMonolog_Logger_MyChannelService()
    {
        $this->services['monolog.logger.my_channel'] = $instance = new \Symfony\Bridge\Monolog\Logger('my_channel');

        $instance->pushProcessor(${($_ = isset($this->services['debug.log_processor']) ? $this->services['debug.log_processor'] : $this->getDebug_LogProcessorService()) && false ?: '_'});
        $instance->pushHandler($this->get('monolog.handler.console'));
        $instance->pushHandler($this->get('monolog.handler.my_channel'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yLtyuwzhBe', 0, 'uR8JXtdcdG+hprmGeUozXH', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter('phpstorm://open?%f:%l', $this->get('request_stack', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->targetDirs[3], '/_profiler/open?file=%f&line=%l#line%l');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b770c36067776.99672941')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'csvReaderDua',
            'database_user' => 'wjoseperez',
            'database_password' => '3squ3l3t0',
            ...
            'monolog.handlers_to_channels' => array(
                ...
                'monolog.handler.my_channel' => array(
                    'type' => 'inclusive',
                    'elements' => array(
                        0 => 'my_channel',
                    ),
            ...
            'console.command.ids' => array(
                0 => 'console_command.csv_import',
                1 => 'doctrine_cache.contains_command',
                2 => 'doctrine_cache.delete_command',
                3 => 'doctrine_cache.flush_command',
                4 => 'doctrine_cache.stats_command',
                5 => 'doctrine.database_create_command',
                6 => 'doctrine.database_drop_command',
                7 => 'doctrine.generate_entities_command',
                8 => 'doctrine.mapping_import_command',
                9 => 'doctrine.cache_clear_metadata_command',
                10 => 'doctrine.cache_clear_query_cache_command',
                11 => 'doctrine.cache_clear_result_command',
                12 => 'doctrine.cache_collection_region_command',
                13 => 'doctrine.mapping_convert_command',
                14 => 'doctrine.schema_create_command',
                15 => 'doctrine.schema_drop_command',
                16 => 'doctrine.ensure_production_settings_command',
                17 => 'doctrine.clear_entity_region_command',
                18 => 'doctrine.database_import_command',
                19 => 'doctrine.mapping_info_command',
                20 => 'doctrine.clear_query_region_command',
                21 => 'doctrine.query_dql_command',
